...
const MenuList = (props) => {
    console.log("the props from menulist:",props)
        ...
        <Grid>
            <Grid className="course">
                ...
                <Grid className="course-info">
                    ...
                    <Box className={classes.categoryHolder} component="span"> <AdjustIcon sx={{ color: 'green', display: 'inline', fontSize: 'small'}}/><h6> &nbsp;Dish Category</h6> </Box>
            ...
            <Grid className="course">
                ...
                <Grid className="course-info">
                    ...
                    <Box className={classes.categoryHolder} component="span"> <AdjustIcon sx={{ color: 'green', display: 'inline'}}/><h6> &nbsp;Dish Category</h6> </Box>
                    <h5>Chicken Tangdi Kebab</h5>
                    <h5>&#x20B9; 369</h5>
                    <StyledRating
                        name="customized-color"
